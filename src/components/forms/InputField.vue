<template>
  <div>
    ...
    <p v-motion-bounce v-if="hasError" class="mt-1 text-sm text-red-600 dark:text-red-400">
      {{ errors[0] }}
    </p>
...
interface InputFieldProps {
  ...
  placeholder?: string
  modelValue: string | number // Menggunakan modelValue untuk v-model
  errors?: string[] // Prop untuk menerima array pesan error
  required?: boolean
...
const props = withDefaults(defineProps<InputFieldProps>(), {
  ...
  label: '',
  placeholder: '',
  errors: () => [], // Default ke array kosong
  required: false,
  autocomplete: 'off',
  disabled: false,
  readonly: false,
...
// Destructure props agar reaktif
